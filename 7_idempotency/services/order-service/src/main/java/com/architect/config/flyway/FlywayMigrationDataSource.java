...
public class FlywayMigrationDataSource implements DataSource {
    ...
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(FlywayMigrationDataSource.class);
    ...
    public void close() {
        try {
            ...
            LOGGER.info("Exception during closing connection: {}", exception.getLocalizedMessage());
        }
